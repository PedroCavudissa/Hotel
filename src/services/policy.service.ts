...
export class PolicyService {
 ...
 static async update(data: any) {
  // Buscar os valores atuais para servir de fallback caso não venham no 'data'
...
static async createNew(data: any) {
  // Este método é apenas para criar uma nova política, não deve ser usado normalmente
