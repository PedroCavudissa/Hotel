...
export class TicketService {
  ...
  static async addMessage(ticketId: string, text: string, actor: AuthUser) {
    ...
    // Criar a mensagem e reabrir o ticket caso o cliente responda a um chamado resolvido
    return prisma.$transaction(async (tx) => {
      ...
      // Se o cliente responder, altera o status para 'OPEN' ou 'PENDING' para alertar a recepção
