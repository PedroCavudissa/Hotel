...
import { ShieldCheck, Wifi, Coffee, Sparkles, Users, MapPin } from "lucide-react";
...
localStorage.clear() // LIMPA LOCALSTORAGE PARA TESTES - REMOVER DEPOIS
  useEffect(() => {
    fetchFeaturedRooms();
  }, []);
  ...
  const fetchFeaturedRooms = async () => {
    try {
      ...
      console.log('Quartos VACANT_CLEAN:', availableRooms);
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
            <div className="space-y-6 md:col-span-3">
              ...
              <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 pt-2">
                ...
                <Link to="/register" className="border border-white/20 hover:bg-white/5 px-6 py-3.5 rounded-xl text-sm font-bold transition-all">
                  Criar conta
                </Link>
              </div>
            </div>
    ...
    <div className="space-y-16 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          { icon: <Coffee size={20} />, title: "Mini-bar curado", text: "Selecção local e internacional." },
