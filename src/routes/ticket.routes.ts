...
router.get("/admin", authMiddleware, requireUser, async (req, res) => {
  try {
...
router.patch("/admin/:id", authMiddleware, requireUser, async (req, res) => {
  try {
...
router.get("/admin/stats", authMiddleware, requireUser, async (req, res) => {
  try {
