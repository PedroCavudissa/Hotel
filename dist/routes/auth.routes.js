...
router.post("/staff", authMiddleware, roleMiddleware(["ADMIN"]), AuthController.createStaff);
router.patch("/disable/:id", authMiddleware, roleMiddleware(["ADMIN"]), AuthController.disable);
router.patch("/activate/:id", authMiddleware, roleMiddleware(["ADMIN"]), AuthController.activate);
